...
You can also supply rankProbes function with a SummarizedExperiment object. In 
that case, if you don't specify a **pheno** object, phenotypes will be 
extracted from the SummarizedExperiment object with _colData_ function.
